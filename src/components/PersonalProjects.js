  ...
  return (
    <div className=" homepage">
      ...
      <div className="ms-5 mt-4 education">
        ...
        <li>
        <ArrowRightRoundedIcon /> <a className='txt-deco blink_me' href='https://github.com/syedwajahat01/FullStack-Ecommerce-WebApp' target='_blank' rel="noopener noreferrer">
        click here </a>
        </li>
          <li>
            <span>
      ...
      <div className="ms-5 mt-4 education">
        ...
        <ul className='txt-deco'>
        <li>
        <ArrowRightRoundedIcon /> <a className='txt-deco blink_me' href='https://github.com/syedwajahat01/Chatting-App' target='_blank' rel="noopener noreferrer">
        click here </a>
        </li>
          <li>
            <span>
